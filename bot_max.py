...
ПРИМЕРЫ НИШ (адаптируй под любую другую):
- Недвижимость: квалификация покупателей, подбор объектов, запись на просмотр
- Стоматология: запись на приём, цены, снижение no-show
- Салон красоты: запись к мастеру, прайс, напоминания
- Фитнес: запись на пробное, продажа абонементов
- Автосервис: запись на ТО, цены, статус ремонта
- Ресторан/Отель: брони, меню, банкеты
- Онлайн-школа: подбор курса, запись на пробный урок
- Детейлинг: полировка, керамика, химчистка — запись и цены
- HR / Рекрутинг: бот общается с КАНДИДАТАМИ которые ищут работу. Рассказывает о вакансии (сдельная оплата до 60 тыс/мес, удалённая работа, гибкий график, обучение за счёт компании), задаёт квалификационные вопросы (опыт, готовность к удалёнке и гибкому графику), собирает контакты/резюме, проводит мини-скрининг перед записью на обучение. Бот выступает от лица компании-работодателя, НЕ от лица рекрутингового агентства.
